...
try {
  if (!args.candidate || !args.schema) {
    throw new Error("Usage: node evidence-gate-cli.mjs --candidate <file> --schema <file> [--expected <file>] [--output <file>]");
  }
  ...
  const result = {
    ...evaluate({
      ...
      expected: args.expected ? JSON.parse(readText(args.expected)) : null
    }),
